...
_PREFIX_ALIASES = [
    ...
    (re.compile(r'^(?:PLANTA\s+)?(?:SOLAR\s+)?(?:FV|FOTOVOLTAICA|SOLAR\s+FV)\s+', re.I), 'PLANTA FOTOVOLTAICA '),
    (re.compile(r'^PFV\s+', re.I), 'PARQUE FOTOVOLTAICO '),
    (re.compile(r'^PSF\s+', re.I), 'PLANTA SOLAR FOTOVOLTAICA '),
    (re.compile(r'^(?:PARQUE|PLANTA|INSTALACION)\s+(?:SOLAR\s+)?FOTOVOLTAICA\s+', re.I), 'PLANTA FOTOVOLTAICA '),
    (re.compile(r'^(?:PARQUE|PLANTA|INSTALACION)\s+SOLAR\s+', re.I), 'PLANTA SOLAR '),
    (re.compile(r'^(?:PARQUE|PLANTA|INSTALACION)\s+EOLICA?\s+', re.I), 'PARQUE EOLICO '),
